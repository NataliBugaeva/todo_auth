...
export const clearTodolistsAC = () => ({type: 'TODOLISTS/CLEAR-TODOLISTS'} as const)
...
export type clearTodolistsACType = ReturnType<typeof clearTodolistsAC>
